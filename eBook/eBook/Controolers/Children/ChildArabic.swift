...
class ChildArabic: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(ChildACell.self,
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell  = collectionView.dequeueReusableCell(withReuseIdentifier: "childCell", for: indexPath) as! ChildACell
        
      
        _ = arabicChildList[indexPath.item]
